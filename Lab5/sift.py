...
img_obj = cv2.imread('/home/mmlab/workspace/CVLaboratories/Test/hog-sift/book.png', 0)
img_scene = cv2.imread('/home/mmlab/workspace/CVLaboratories/Test/hog-sift/box_in_scene.png', 0)

img_1 = img_obj.copy()
img_2 = img_scene.copy()
